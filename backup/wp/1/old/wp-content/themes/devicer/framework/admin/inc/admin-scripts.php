...
function devicer_admin_register($hook) {
	...
	wp_localize_script( 'wp-color-picker', 'wpColorPickerL10n', array(
		'clear' => 					esc_attr__('Clear', 'devicer'),
		'clearAriaLabel' => 		esc_attr__('Clear color', 'devicer'),
		'defaultLabel' => 			esc_attr__('Color value', 'devicer'),
		'defaultString' => 			esc_attr__('Default', 'devicer'),
		'defaultAriaLabel' => 		esc_attr__('Select default color', 'devicer'),
		'pick' => 					esc_attr__('Select Color', 'devicer'),
	) ); 
