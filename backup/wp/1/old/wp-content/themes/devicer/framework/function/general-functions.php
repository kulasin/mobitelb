...
function devicer_generate_front_css() {
	$cmsmasters_page_id = devicer_get_singular_id();
...
/* Get Singular ID */
function devicer_get_singular_id() {
	$id = false;
...
function devicer_theme_style_change() {
	...
	if ('hold' === get_option('cmsmasters_devicer_theme_style_change')) {
		return;
	} else {
		...
		update_option('cmsmasters_devicer_theme_style_change', 'hold');
	}
}
