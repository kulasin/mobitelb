...
/***************** Start {$title} Color Scheme Rules ******************/
	...
	{$rule}.cmsmasters_mailpoet .cmsmasters_mailpoet_form .mailpoet_paragraph + .mailpoet_paragraph .mailpoet_submit,
	...
	{$rule}div.wpforms-container div.wpforms-field-container div.wpforms-field.wpforms-field-radio ul > li input[type=radio] + label:after,
	{$rule}div.wpforms-container div.wpforms-field-container div.wpforms-field.wpforms-field-checkbox ul > li input[type=checkbox] + label:after,
	{$rule}.nf-form-wrap .nf-form-layout .nf-form-content .list-checkbox-wrap ul > li input[type=checkbox] + label:after, 
	{$rule}.nf-form-wrap .nf-form-layout .nf-form-content .list-radio-wrap ul > li input[type=radio] + label:after, 
	{$rule}.nf-form-wrap .nf-form-layout .nf-form-content .checkbox-container .checkbox-wrap .nf-field-label label:after,
	...
	{$rule}.cmsmasters_contact_form div.wpforms-container .wpforms-form textarea:focus,
	{$rule}.cmsmasters_contact_form div.wpforms-container .wpforms-form input:not([type=button]):not([type=checkbox]):not([type=file]):not([type=hidden]):not([type=image]):not([type=radio]):not([type=reset]):not([type=submit]):not([type=color]):not([type=range]):focus,
	...
	@media only screen and (max-width: 540px) {
		...
		{$rule}.cmsmasters_mailpoet .cmsmasters_mailpoet_form .mailpoet_paragraph + .mailpoet_paragraph .mailpoet_submit:hover {
			" . cmsmasters_color_css('background-color', $cmsmasters_option['devicer' . '_' . $scheme . '_link']) . "
		}
	}
	...
	{$rule}input:not([type=button]):not([type=checkbox]):not([type=file]):not([type=hidden]):not([type=image]):not([type=radio]):not([type=reset]):not([type=submit]):not([type=color]):not([type=range]),
	{$rule}.cmsmasters_contact_form div.wpforms-container .wpforms-form textarea,
	{$rule}textarea,
	{$rule}option,
	{$rule}.cmsmasters_button,
	{$rule}.button,
	...
	{$rule}.wpcf7 form.wpcf7-form span.wpcf7-list-item input[type=radio] + span.wpcf7-list-item-label:before, 
	{$rule}.cmsmasters-form-builder .check_parent input[type=radio] + label:before,
	{$rule}div.wpforms-container div.wpforms-field-container div.wpforms-field.wpforms-field-radio ul > li input[type=radio] + label:before,
	{$rule}div.wpforms-container div.wpforms-field-container div.wpforms-field.wpforms-field-checkbox ul > li input[type=checkbox] + label:before,
	{$rule}.nf-form-wrap .nf-form-layout .nf-form-content .list-checkbox-wrap ul > li input[type=checkbox] + label:before, 
	{$rule}.nf-form-wrap .nf-form-layout .nf-form-content .list-radio-wrap ul > li input[type=radio] + label:before, 
	{$rule}.nf-form-wrap .nf-form-layout .nf-form-content .checkbox-container .checkbox-wrap .nf-field-label label:before,
	{$rule}.cmsmasters_contact_form div.wpforms-container .wpforms-form input:not([type=button]):not([type=checkbox]):not([type=file]):not([type=hidden]):not([type=image]):not([type=radio]):not([type=reset]):not([type=submit]):not([type=color]):not([type=range]),
	{$rule}.cmsmasters_contact_form div.wpforms-container .wpforms-form textarea,
	{$rule}.cmsmasters_contact_form div.wpforms-container .wpforms-form select,
	{$rule}.error_cont .error_button_wrap a:hover,
	{$rule}.cmsmasters_counters .cmsmasters_counter_wrap .cmsmasters_counter .cmsmasters_counter_inner:before,
