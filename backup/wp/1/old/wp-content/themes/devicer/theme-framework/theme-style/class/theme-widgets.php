...
class WP_Widget_Custom_Latest_Projects extends WP_Widget {
	...
	function form($instance) {
		...
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('likes')); ?>"><?php esc_html_e('Show likes', 'devicer'); ?></label>
		</p>
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('comments')); ?>"><?php esc_html_e('Show comments', 'devicer'); ?></label>
		</p>
		<div class="cl"></div>
		<?php
	}
			...
			if ($tweets != '') {
				...
				echo '<div class="cmsmasters_notice cmsmasters_notice_error cmsmasters_theme_icon_cancel">' . "\n" . 
					'<div class="notice_content">' . "\n" . 
						'<p>' . esc_html__('Please add your Twitter API keys', 'devicer') . ', ' . '<a target="_blank" href="//cmsmasters.net/twitter-functionality/">' . esc_html__('read more how', 'devicer') . '</a></p>' . "\n" .
					'</div>' . "\n" . 
				'</div>' . "\n";
			}
		}
