...
$rocket_cookie_hash = '38f29ff3df04a5c0be9477b91d3f7c8b';
$rocket_logged_in_cookie = 'wordpress_logged_in_38f29ff3df04a5c0be9477b91d3f7c8b';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_cache_ssl = 1;
$rocket_cache_mobile = 0;
$rocket_do_caching_mobile_files = 0;
$rocket_cache_reject_uri = '/new(/(?:.+/)?feed(?:/(?:.+/?)?)?$|/(?:.+/)?embed/|/checkout/(.*)|/cart/|/my-account/(.*)|/wc-api/v(.*)|/(index\.php/)?wp\-json(/.*|$))';
