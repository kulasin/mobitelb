								...
								<div class="col-lg-6 static">
									<div class="slide-text white">
                                     ...
                                     <h3 class="owl-slide-animated owl-slide-title mt-2">4099.99 km</h3>
										<div class="owl-slide-animated owl-slide-cta"><a class="btn_1" href="{{ route('product.show', '8893') }}" role="button">POGLEDAJ</a></div>
									</div>
								...
								<div class="col-lg-6 static">
									<div class="slide-text text-end white">
                                       <p class="owl-slide-animated owl-slide-subtitle" style="margin-bottom: 0">
										...
										<div  class="owl-slide-animated owl-slide-cta"><a class="btn_1" href="{{ route('product.show', '8898') }}" role="button">POGLEDAJ</a></div>
                            ...
                            <div class="row justify-content-center justify-content-md-start">
								<div class="col-lg-6 static">
									<div class="slide-text white">
										...
										<div class="owl-slide-animated owl-slide-cta"  style="width: unset!important"><a class="btn_1" href="{{ route('product.show', '8894') }}" role="button">SPACE GRAY</a></div> 
                                            </div> 
                                          <div class="row  mt-2">
                                        ...
                                        <div class="owl-slide-animated owl-slide-cta"  style="width: unset!important"><a class="btn_1" href="{{ route('product.show', '8894') }}" role="button">SILVER</a></div> 
                                        </div>
									</div>
					...
					<div class="row justify-content-center justify-content-md-start">
						<div class="col-lg-6 wow" data-wow-offset="150">
							...
							<div class="feat_text_block">
								...
								<a class="btn_1" href="{{ route('product.show', '8894') }}" role="button">POGLEDAJ</a>
							</div>
						</div>
					</div>
				</div>
