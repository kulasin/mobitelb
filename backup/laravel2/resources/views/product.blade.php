	        ...
	        <div class="row">
	             <div class="col-md-6">
	                <div class="all">
                        ...
                        <div style="background-image: url('{{ asset('../resources/img/uploads/' . $image) }}')" data-src="{{ asset('../resources/img/uploads/' . $image) }}" class="item-box bg-container"></div>
                    @endforeach
	                        </div>
	                    ...
	                    <div class="slider-two">
							...
							@foreach ($product->images as $image)
                        <div style="background-image: url('{{ asset('../resources/img/uploads/' . $image) }}')" data-src="{{ asset('../resources/img/uploads/' . $image) }}" class="item"></div>
                    @endforeach
					...
					<div class="grid_item">
						...
						<figure>
							<a href="{{ route('product.show', ['id' => $product->id]) }}">
								<img class="owl-lazy" src="https://iqmobile.ba/wp-content/uploads/2022/09/WWEN_iPhone14_Q422_Midnight_PDP_Image_Position-1a.jpg" data-src="https://iqmobile.ba/wp-content/uploads/2022/09/WWEN_iPhone14_Q422_Midnight_PDP_Image_Position-1a.jpg" alt="">
							</a>
							@if ($product->sale_active === 1)
